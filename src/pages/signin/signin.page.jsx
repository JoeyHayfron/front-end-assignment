...
class SignIn extends React.Component{
    ...
    handleSubmit = (event) => {
        ...
        .then((user) => {
            if(user)
                this.props.history.push("/front-end-assignment/");
    ...
    render(){
        return (
            <div className="signin__container">
                ...
                <p className="account-exist">Don't have an account? <Link to="/front-end-assignment/register" className="login-sign-link">Register</Link></p>
